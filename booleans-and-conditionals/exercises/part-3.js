...
if (fuelLevel < 1000 || engineTemperature > 3500 ||         engineIndicatorLight === "red blinking") {
  ...
  console.log("Full tank. Engines good.");
    ...
    console.log("Fuel Level abouve 50%. Engines good.");
  }  
...
if (!commandOverride && fuelLevel > 20000 && engineIndicatorLight === !"red blinking") {
  console.log("Good to Launch, fuel is full and engine is OK");
}
    else if (!commandOverride && fuelLevel <= 20000 || engineIndicatorLight ==="red blinking") {
    console.log("NOT Good to Launch, fuel not full OR engine status is blinking red");
    } 
    else if (commandOverride) {
      console.log("GOOD to Launch, regardless of fuel and engine status.");
    }
